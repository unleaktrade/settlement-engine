...
describe("Config – init/update/close", () => {
    ...
    const usdcMint = Keypair.generate().publicKey; // placeholder mint for this test
    ...
    it("update_config lets admin rotate fields", async () => {
        ...
        await program.methods
            .updateConfig(newAdmin, null, null) // change admin only
    ...
    it("close_config closes the PDA and refunds rent to admin", async () => {
        ...
        // attempting to fetch must now fail
        try {
